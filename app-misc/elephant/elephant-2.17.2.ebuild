...
SLOT="0"
KEYWORDS="~amd64"
IUSE="1password bluetooth bookmarks calc clipboard +desktopapplications files menus nirisessions providerlist runner snippets symbols todo unicode websearch windows"
